...
export default function Navbar() {
  ...
  return (
    <div className="navbarContainer flex items-center sticky top-0">
      ...
      <Link to ="/"> <span className="logo text-xl font-extrabold ml-10 mr-2 "><span className="text-3xl">C</span>loudConnect </span></Link>
      </div>
      ...
      <div className="navbarRight flex items-center justify-around text-white">
        ...
        <img className="ProfilePicture rounded-2xl cursor-pointer" src= { user.profilePicture ? PF +user.profilePicture : PF +"nopic.jpg"} alt="ProfilePicutre" />
        </Link>
      </div>
    </div>
  );
